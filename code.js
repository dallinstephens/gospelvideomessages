...
function BigFunction(x,y) {
    ...
    if (ShowSlideBoxOrShowVideoDescription == 1 & VideoSelected == 0) {
        ...
        document.getElementById("showVideo").innerHTML = '<img onmouseover = "PreviousPlayPauseNext(); previous(); next(); pauseit(); play(); showExplain3(); slideVideo();" id="Big" style = "position:absolute; top:81.5%; right:0; left:0; margin:auto; width:700px; height:82px; z-index:3;"' + 'src="./buttons/TransparentImage.png" alt="" border="0" /></a>';
