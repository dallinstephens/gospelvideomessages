...
alternativePicture[0]="http://www.pestalance.co.uk/sites/pestalance.co.uk/files/pictures/foxy.jpg"; alternativePicture[4]="http://ldstemplephotography.net/smugCache/132067495_hSDw82D-M.jpg"; 
...
else if (step==111 || step==115) {g = step - 111; mycode = "<img style='position: relative; top:28px; width:700px; height:393px' src='" + alternativePicture[g] + "' border='0' />";}
