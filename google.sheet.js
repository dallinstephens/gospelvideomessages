...
WordOnButton = [ "Atonement..." , "Commandments, ..." , "Commandments:<..." , "Light..." , "Lord, Feeling ..." , "Love..." , "Music Video..." , "Priesthood, Ke..." ];
...
[ "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Atonement</p><p class = 'middle'></p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Commandments, Keep the</p><p class = 'middle'>(see also Commandments: Restrictive or Liberating?)</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Commandments:<br>Are the commandments restrictive or liberating?</p><p class = 'middle'>(see also Commandments, Keep the)</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Light</p><p class = 'middle'></p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Lord, Feeling Close to the</p><p class = 'middle'></p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Love</p><p class = 'middle'></p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Music Video</p><p class = 'middle'></p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Priesthood, Keys of the</p><p class = 'middle'>(see also Authority; Power)</p></a></div>" ];}
...
[ "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Atonement</p><p class = 'middle'>Because of Him</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Commandments, Keep the</p><p class = 'middle'>President Thomas S. Monson</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Commandments, Keep the</p><p class = 'middle'>Sister Mary R. Durham</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Commandments:<br>Are the commandments restrictive or liberating?</p><p class = 'middle'>President Thomas S. Monson</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Light</p><p class = 'middle'>Elder David A. Bednar</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Light: Be a Light in the Lives of Others</p><p class = 'middle'>President Thomas S. Monson</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Lord, Feeling Close to the</p><p class = 'middle'>President Henry B. Eyring</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Lord, Feeling Close to the</p><p class = 'middle'>Elder Donald L. Hallstrom</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Lord, Feeling Close to the</p><p class = 'middle'>Elder Kevin R. Duncan</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Love</p><p class = 'middle'>Elder Jeffrey R. Holland</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Music Video</p><p class = 'middle'>Sister Hilary Weeks</p></a></div>" , "<div class='textinmiddle'><a class = 'small'><p class = 'top'>Priesthood, Keys of the</p><p class = 'middle'>Elder Gary E. Stevenson</p></a></div>" ];
...
var video = [ "_S3TI4bYerU" , "n-nYIHjsogg" , "TajfxA1D8N0" , "n-nYIHjsogg" , "slTa15a3mp0" , "OtsuwtP3d2Y" , "a30otKYGe1o" , "es4Y-lvlTgw" , "UlvYMKRtMkI" , "6MnLVTO4oDA" , "xyX-I-um5Kk" , "iFLGI8JJV8k" ];
...
author = [ "Because of Him" , "Thomas S. Monson" , "Mary R. Durham" , "Thomas S. Monson" , "David A. Bednar" , "Thomas S. Monson" , "Henry B. Eyring" , "Donald L. Hallstrom" , "Kevin R. Duncan" , "Jeffrey R. Holland" , "Hilary Weeks" , "Gary E. Stevenson" ];

sourceName = [ "Because of Him" , "Keep the Commandments" , "A Child\'s Guiding Gift" , "Keep the Commandments" , "Patterns of Light: Spirit of Revelation" , "Be a Light in the Lives of Others" , "Where Two or Three Are Gathered" , "I Am a Child of God" , "The Healing Ointment of Forgiveness" , "Tomorrow the Lord Will Do Wonders among You" , "Beautiful Heartbreak " , "Where Are the Keys and Authority of the Priesthood?" ];

source = [ "LDS Website" , "General Conference" , "General Conference" , "General Conference" , "Mormon Messages" , "LDS Media Library" , "General Conference" , "General Conference" , "General Conference" , "General Conference" , "General Conference" , "General Conference" ];

monthYear = [ "April 2014" , "October 2015" , "April 2016" , "October 2015" , "September 2012" , "October 2015" , "April 2016" , "April 2016" , "April 2016" , "April 2016" , "October 2011" , "April 2016" ];
